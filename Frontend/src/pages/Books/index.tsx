...
// import AuthorsTab from "@/components/books/authorsTab";
// import BooksTab from "@/components/books/booksTab";
// import GenresTab from "@/components/books/genresTab";
...
//       <Box sx={{ padding: "10px", borderBottom: 1, borderColor: "divider", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
//         <Box sx={{ display: "flex", gap: 2 }}>
//           <Typography variant="h6">Library Management</Typography>
//           <Tabs value={tabIndex} onChange={handleTabChange} sx={{ display: "flex", gap: 2 }}>
//             <Tab label="Books" />
//             <Tab label="Authors" />
//             <Tab label="Genres" />
//           </Tabs>
...
//           {!isAuthenticated ? (
//             <Box>
//               <Button onClick={() => router.push("/login")} variant="contained" color="primary" sx={{ marginRight: 2 }}>
//                 Login
//               </Button>
//             </Box>
//           ) : (
